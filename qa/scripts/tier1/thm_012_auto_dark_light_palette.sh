...
qa_keys "ctrl-space"
qa_send "theme" 0.3
qa_assert_screen "Theme: Auto" "Theme: Auto entry visible in palette"
qa_assert_screen "Theme: Dark" "Theme: Dark entry visible in palette"
qa_assert_screen "Theme: Light" "Theme: Light entry visible in palette"
qa_keys "escape"
qa_keys "escape"
...
qa_keys "ctrl-space"
qa_send "theme" 0.3
qa_assert_screen '\[dark\]' "Fresh state starts explicit dark"
qa_keys "escape"
qa_keys "escape"
...
qa_keys "ctrl-space"
qa_send "theme" 0.3
qa_assert_screen '\[light\]' "Theme: Light selected directly sets light"
qa_keys "escape"
qa_keys "escape"
...
qa_keys "ctrl-space"
qa_send "theme" 0.3
qa_assert_screen '\[dark\]' "Theme: Dark selected directly sets dark"
qa_keys "escape"
qa_keys "escape"
