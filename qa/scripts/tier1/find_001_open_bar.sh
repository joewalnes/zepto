...
qa_assert_screen "Esc|Find|Aa" "find bar visible (Esc/Find/Aa indicator)"
...
qa_assert_screen "[12] of [12]|2|matches" "match count visible (2 matches expected)"
...
qa_assert_screen "hello" "editor content visible after find close"
