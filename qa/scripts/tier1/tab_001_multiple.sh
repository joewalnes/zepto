...
qa_assert_screen "tab001_a" "tab A visible"
qa_assert_screen "tab001_b" "tab B visible"

# First file should be active — its content shown
qa_assert_screen "content of file A" "file A content displayed"

# Switch to next tab (Alt+. = ESC then .)
qa_keys "alt-."
qa_assert_screen "content of file B" "file B content after tab switch"

# Switch back (Alt+, = ESC then ,)
qa_keys "alt-,"
qa_assert_screen "content of file A" "file A content after switching back"
