...
qa_assert_expect "line 1 " "starts showing line 1"

# Scroll down
hangon mouse-scroll "$QA_SESSION" --x 20 --y 10 --delta 10
sleep 0.3

qa_assert_expect "line (1[0-9]|2[0-9])" "scroll down moved viewport"

# Scroll back up
hangon mouse-scroll "$QA_SESSION" --x 20 --y 10 --delta -10
sleep 0.3

qa_assert_expect "line 1 " "scroll up returned to top"
