#!/usr/bin/env bash
# QA-REG-231: the tab bar's close/tabs/quit corner hint must render as
...
qa_header "QA-REG-231: Tab bar corner hint renders as Title Case pills, never overflows"
