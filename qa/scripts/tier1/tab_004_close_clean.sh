...
# Three tabs visible
qa_assert_expect "tab004_a" "tab A visible"
qa_assert_expect "tab004_c" "tab C visible"

# Switch to tab 2 and close it
qa_keys "alt-."
qa_assert_expect "file B" "file B active"
...
qa_assert_expect "tab004_a|tab004_c" "remaining tabs still visible"
