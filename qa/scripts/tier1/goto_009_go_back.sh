...
qa_send "50" 0.2
qa_keys "enter"
qa_assert_expect "50" "at line 50"

# Jump to line 80
qa_keys "ctrl-g"
qa_send "80" 0.2
qa_keys "enter"
qa_assert_expect "80" "at line 80"

# Go Back (Alt+-)
qa_keys "alt--"
qa_assert_expect "50" "go back returns to line 50"

# Go Forward (Alt+=)
qa_keys "alt-="
qa_assert_expect "80" "go forward returns to line 80"
