...
qa_assert_expect "AAA_content" "starts on tab 1"

# Next tab (Alt+.)
qa_keys "alt-."
qa_assert_expect "BBB_content" "alt-. moved to tab 2"

# Next tab again
qa_keys "alt-."
qa_assert_expect "CCC_content" "alt-. moved to tab 3"

# Prev tab (Alt+,)
qa_keys "alt-,"
qa_assert_expect "BBB_content" "alt-, moved back to tab 2"

# Prev tab again
qa_keys "alt-,"
qa_assert_expect "AAA_content" "alt-, moved back to tab 1"
