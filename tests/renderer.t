...
# ----------------------------------------------------------------------------
# QA-REG-231: the tab bar's corner-hint pill group must never, at any
...
# ----------------------------------------------------------------------------
subtest 'Tab bar row never exceeds $cols at any width, with or without the corner hint (QA-REG-231)' => sub {
    my $theme = Zepto::Theme->dark_theme();
